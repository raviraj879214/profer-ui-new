...
export function NotesTimeLine({ companyid, setNotePopup  }) {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-2xl  h-[90vh] ml-4 p-5 relative flex flex-col">
            ...
            <div className="mt-4 border-t border-gray-200 pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
  <input
    type="text"
  ...
  <button
    ...
    className={`bg-gray-900 text-white px-4 py-2 rounded-lg text-sm w-full sm:w-auto ${
