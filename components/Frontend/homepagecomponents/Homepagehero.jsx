            ...
            <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto">
                ...
                <div className="md:w-1/2 text-center md:text-left">
                    ...
                    <form onSubmit={handleSubmit(onsubmit)}>
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-center md:justify-start gap-4">
                            {/* Company Name Input */}
                            ...
                            <div className="flex flex-col">
                                <input
                                    ...
                                    className="border border-gray-300 px-6 py-3 rounded-md w-full sm:w-40 shadow text-gray-900 text-base"
                                    {...register("zipcode", {
                            ...
                            {/* Verify Button */}
                            <button className="bg-red-500 text-white px-8 py-3 rounded-md font-semibold shadow self-stretch sm:self-auto">
                                Verify
                            </button>
                        </div>
