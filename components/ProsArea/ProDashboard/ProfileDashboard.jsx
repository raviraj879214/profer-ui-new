  ...
  const fetchsocialmedialinks = async () => {
    try {
      ...
      if (result.status === 200 && result.data) {
        ...
        // No data returned - keep empty defaults
        setAboutInfo({
          phone: "",
          website: "",
          maps: "",
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 p-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-900">
        ...
        <div className="col-span-1 md:col-span-1 flex flex-col">
          <div className="flex items-center space-x-4">
            <img
              src="/images/proverified.avif"
              alt="Pro Verified Icon"
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 min-h-[300px]">
          ...
          <ul className="space-y-4 text-blue-600 text-sm font-medium">
            <EditableField
              ...
              setValue={(val) =>
                setAboutInfo((prev) => ({ ...prev, phone: val }))
              }
              linkPrefix="tel:"
            ...
            <EditableField
              ...
              setValue={(val) =>
                setAboutInfo((prev) => ({ ...prev, website: val }))
              }
              onSave={handleSaveField}
            />
            <EditableField
              ...
              setValue={(val) =>
                setAboutInfo((prev) => ({ ...prev, maps: val }))
              }
              onSave={handleSaveField}
            />
            <EditableField
              ...
              setValue={(val) =>
                setAboutInfo((prev) => ({ ...prev, facebook: val }))
              }
              onSave={handleSaveField}
            />
          </ul>
